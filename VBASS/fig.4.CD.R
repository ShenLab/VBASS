...
train.input <- read.csv('AutoEncoderTADA.input.simulation.realexp/input.x.1.csv', row.names = 1)
train.input.var <- read.csv('AutoEncoderTADA.input.simulation.realexp/input.x_var.1.csv', row.names = 1)
...
real.pi <- read.csv('AutoEncoderTADA.input.simulation.realexp/real.pi.csv', row.names = 1)
train.x.label <- read.csv('AutoEncoderTADA.input.simulation.realexp/input.label.1.csv', row.names = 1)
true.x.label <- read.csv('AutoEncoderTADA.input.simulation.realexp/test.label.1.csv', row.names = 1)
...
ggsave(plot = p, filename = paste0(out.folder, "fig.4.C.pdf"), height = 5, width = 5)
...
ggsave(plot = p, filename = paste0(out.folder, "fig.4.D.pdf"), height = 5, width = 5)
