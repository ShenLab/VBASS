...
correlation_array.1 <- correlation_array[1:floor(dim(correlation_array)[1]/2),]
correlation_array.2 <- correlation_array[(floor(dim(correlation_array)[1]/2)+1):dim(correlation_array)[1],]
...
ggsave(plot = p, filename = paste0(out.folder, "fig.5.C.1.pdf"), height = 4, width = 6)
...
ggsave(plot = p, filename = paste0(out.folder, "fig.5.C.2.pdf"), height = 4, width = 6)