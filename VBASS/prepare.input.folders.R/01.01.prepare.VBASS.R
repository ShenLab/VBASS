...
write.csv(genes.x, file = 'VBASS.input/input.x.csv')
# begin x.var
...
write.csv(genes.x_var, file = 'VBASS.input/input.x_var.csv')
# begin gene.label
library(dplyr)
...
write.csv(genes.label, file = 'VBASS.input/input.label.csv')

write.csv(label.file.testing, file = "VBASS.input/testing.label.csv")
