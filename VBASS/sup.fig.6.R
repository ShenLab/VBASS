kl <- c(1.0, 0.6, 0.8, 1.2, 1.4, 2.0, 3.0, 'dry.run')
...
write.csv(to.plot.FDR, 'figs/sup.fig.6.kls.FDR.csv')
write.csv(to.plot.PR, 'figs/sup.fig.6.kls.PR.csv')
to.plot.FDR <- to.plot.FDR[to.plot.FDR$kl.ratio %in% c("0.6", "0.8", "1", "2", "3", "dry.run"),]
