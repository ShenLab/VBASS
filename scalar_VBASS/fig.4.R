...
source('scalar_VBASS/draw.VBASS.S_distribution.R')
draw.VBASS.S_distribution.from.pars0(VBASS_result$pars0, savefilename = "figs/fig.4.A.pdf")
write.csv(VBASS_result$pars0, file = 'figs/fig.4.A.csv')
...
ggsave(plot = p, filename = paste0('figs/fig.4.C.pdf'), width = 6, height = 5)
write.csv(dnv_table, 'figs/fig.4.C.csv')