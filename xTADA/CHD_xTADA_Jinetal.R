...
modelfile = modelfile[modelfile != "simulated_gene_set_xTADA.R"]
for (ii in modelfile) {
...
result = gene_set_xtada(geneset, cases, samplenumber, reference, covariatesData)
saveRDS(result, file = "result/CHD_xTADA_expression.RDS")
